export const translations = {
  en: {
    ...
    less: "Less than expected",
    expected: "As expected",
    more: "More than expected",
    challengeQuestion: "Did you face any challenges?",
    equipment: "Lack of equipment",
    instructions: "Incomplete instructions",
    shortage: "Shortage of cleaning products",
  ...
  tr: {
    ...
    registrationSuccess: "Hesap başarıyla kaydedildi!",
    ...
    less: "Beklenenden az",
    expected: "Beklendiği gibi",
    more: "Beklenenden fazla",
    challengeQuestion: "Herhangi bir zorlukla karşılaştınız mı?",
    equipment: "Ekipman eksikliği",
    instructions: "Eksik talimatlar",
    shortage: "Temizlik ürünü eksikliği",
    ...
    product: "1. Ürün",
    challenge: "2. Zorluk",
    safety: "3. Güvenlik Sorunu",
    condition: "4. Durum",
    satisfaction: "5. Memnuniyet",
